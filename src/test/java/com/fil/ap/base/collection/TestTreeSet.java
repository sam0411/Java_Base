package com.fil.ap.base.collection;
...
public class TestTreeSet {
    ...
    // 顺序遍历TreeSet
    private void ascIteratorThroughIterator(TreeSet<String> set) {
    ...
    // 逆序遍历TreeSet
    private void descIteratorThroughIterator(TreeSet<String> set) {
    ...
    // 通过for-each遍历TreeSet。不推荐！此方法需要先将Set转换为数组
    private void foreachTreeSet(TreeSet<String> set) {
